...
from golearn.algorithms import get_algorithm, name2alg
from golearn.imb_algorithms import get_imb_algorithm, name2imbalg
from golearn.core.utils import get_net_builder, get_logger, get_port, send_model_cuda, count_parameters, over_write_args_from_file, TBLog


def get_config():
    from golearn.algorithms.utils import str2bool
    ...
    parser.add_argument('--transition_ratio', type=float, default=0.1, help="transition ratio of labeled data between different split tasks, default to 0.1")
...
def main(args):
    ...
    '''
    args.num_train_iter = args.num_labels // args.batch_size
